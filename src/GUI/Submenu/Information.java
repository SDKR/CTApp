...
public void addActionListenerAboutUs(ActionListener l) {
    ...
    public void getAboutUsBtn(String text) {
        AboutUsBtn.setText(text);
    }

    public void getDepartureBtn(String text) {
        DepartureBtn.setText(text);
    }

    public void getMenuBtn(String text) {
        MenuBtn.setText(text);
    }

    public void getRouteInfoBtn(String text) {
        RouteInfoBtn.setText(text);
    }

    public void getTicketInfoBtn(String text) {
        TicketInfoBtn.setText(text);
    }
