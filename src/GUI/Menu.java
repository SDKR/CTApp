...
public class Menu extends javax.swing.JPanel {
    ...
    public void getQuizBtn(String text) {
        QuizBtn.setText(text);
    }

    public void getInformationBtn(String text) {
        informationBtn.setText(text);
    }

    public void getInformationOnSightBtn(String text) {
        informationOnSightBtn.setText(text);
    }

    public void getLanguageBtn(String text) {
